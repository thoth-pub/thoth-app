...
export type GetUserQuery = { __typename?: 'QueryRoot', me: { __typename?: 'Me', userId: string, email?: string | null, firstName?: string | null, lastName?: string | null, isSuperuser: boolean, publisherContexts: Array<{ __typename?: 'PublisherContext', publisher: { __typename?: 'Publisher', publisherName: string, publisherId: any, imprints: Array<{ __typename?: 'Imprint', imprintId: any, imprintName: string }> }, permissions: { __typename?: 'PublisherPermissions', publisherAdmin: boolean, workLifecycle: boolean, cdnWrite: boolean } }> } };

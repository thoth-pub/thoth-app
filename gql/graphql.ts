...
export type MoveSetRelationMutationVariables = Exact<{
  workRelationId: Scalars['Uuid']['input'];
  newOrdinal: Scalars['Int']['input'];
}>;


export type MoveSetRelationMutation = { __typename?: 'MutationRoot', moveWorkRelation: { __typename?: 'WorkRelation', workRelationId: any } };
...
export const MoveSetRelationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MoveSetRelation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workRelationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"newOrdinal"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moveWorkRelation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"workRelationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workRelationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"newOrdinal"},"value":{"kind":"Variable","name":{"kind":"Name","value":"newOrdinal"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workRelationId"}}]}}]}}]} as unknown as DocumentNode<MoveSetRelationMutation, MoveSetRelationMutationVariables>;

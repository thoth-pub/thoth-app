...
export type SetFragmentFragment = { __typename?: 'Work', workId: any, workType: WorkType, updatedAt: any, titles: Array<{ __typename?: 'Title', canonical: boolean, fullTitle: string, localeCode: LocaleCode, subtitle?: string | null, title: string, titleId: any }> } & { ' $fragmentName'?: 'SetFragmentFragment' };

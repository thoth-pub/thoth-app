...
describe('isContributorsRolesEqual', () => {
  ...
  it('should return true if the contributors are empty in all chapters', () => {
    const areSame = isContributorsRolesEqual([chapter1, chapter2]);
  ...
  it('should return true if the contributors are the same in all chapters', () => {
    ...
    const contributions = [
      getDefaultContribution({ id: faker.string.uuid(), contributorId: contributor.id, type: ContributionType.Author }),
    ];

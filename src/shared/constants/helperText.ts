export const HELPER_TEXT = {
  ...
  PUBLICATION_ACCESSIBILITY_STANDARD: 'Enter the accessibility standard of the publication.',
  PUBLICATION_ACCESSIBILITY_EXCEPTION: 'Enter the accessibility exception of the publication.',
  PUBLICATION_ACCESSIBILITY_REPORT_URL: 'Enter the accessibility report URL or report of the publication.',
  PUBLICATION_ACCESSIBILITY_ADDITIONAL_STANDARD: 'Enter the accessibility additional standard of the publication.',

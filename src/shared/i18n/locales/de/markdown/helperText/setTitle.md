...
Dieser Bereich verwaltet den **Titel** eines Buchsets. Ein Buchset ist eine abgeschlossene Folge von Bänden, die gemeinsam veröffentlicht werden und ein einziges Werk bilden.

Im Bearbeitungsmodus können die folgenden Felder bearbeitet werden:

- **Titel**: Texteingabe für den Titel des Buchsets.
- **Untertitel**: Texteingabe für den Untertitel des Buchsets, üblicherweise durch einen Doppelpunkt vom Titel getrennt.
...
Das **Sprache**-Dropdown ermöglicht die Festlegung der Sprache für **Titel** und **Untertitel**. Die Liste der zulässigen Sprachen und Sprachvarianten umfasst einen zweistelligen [ISO 639-1](https://www.loc.gov/standards/iso639-2/php/code_list.php)-Sprachcode gefolgt von einem zweistelligen [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes)-Ländercode. Die Standardsprache kann unter Verlag > Impressum > Standardsprache festgelegt werden.

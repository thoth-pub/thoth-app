...
describe('EditAdditionalResourceFields', () => {
  it('renders EditAdditionalResourceAttribution', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceAttribution workId="w1" category="test" /></Wrapper>);
    expect(container).toBeDefined();
  });

  it('renders EditAdditionalResourceDescription', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceDescription workId="w1" /></Wrapper>);
    expect(container).toBeDefined();
  });

  it('renders EditAdditionalResourceDoi', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceDoi workId="w1" /></Wrapper>);
    expect(container).toBeDefined();
  });

  it('renders EditAdditionalResourceHandle', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceHandle workId="w1" /></Wrapper>);
    expect(container).toBeDefined();
  });

  it('renders EditAdditionalResourceResourceType', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceResourceType workId="w1" /></Wrapper>);
    expect(container).toBeDefined();
  });

  it('renders EditAdditionalResourceTitle', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceTitle workId="w1" /></Wrapper>);
    expect(container).toBeDefined();
  });

  it('renders EditAdditionalResourceUrl', () => {
    const { container } = render(<Wrapper><EditAdditionalResourceUrl workId="w1" /></Wrapper>);
    expect(container).toBeDefined();
  });
});
